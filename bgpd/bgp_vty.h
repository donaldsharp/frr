...
extern void bgp_clear_soft_out(struct bgp *bgp, afi_t afi, safi_t safi);
extern void bgp_clear_all_soft_in(struct bgp *bgp);
...
extern int bgp_global_gr_config(bool on, bool disable, char *errmsg,
				size_t errmsg_len);
extern int bgp_global_graceful_shutdown_set(bool enable, char *errmsg,
					    size_t errmsg_len);
