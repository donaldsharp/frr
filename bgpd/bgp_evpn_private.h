...
extern void bgp_evpn_handle_deferred_bestpath_for_vnis(struct bgp *bgp,
						       uint16_t cnt);
extern uint16_t bgp_deferred_path_selection(struct bgp *bgp, afi_t afi,
					    safi_t safi,
					    struct bgp_table *table,
					    uint16_t cnt, struct bgpevpn *vpn,
					    bool evpn_select);
