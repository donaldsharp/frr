...
DEFPY(show_ip_ospf_instance_route_orr, show_ip_ospf_instance_route_orr_cmd,
      "show ip ospf (1-65535)$instance route orr [WORD$orr_group]",
      SHOW_STR IP_STR OSPF_STR "Instance ID\n"
			       "OSPF routing table\n"
...
DEFPY(show_ip_ospf_route_orr, show_ip_ospf_route_orr_cmd,
      "show ip ospf [vrf <NAME$vrf_name|all$all_vrf>] route orr [WORD$orr_group]",
      SHOW_STR IP_STR OSPF_STR VRF_CMD_HELP_STR "All VRFs\n"
						"OSPF routing table\n"
						"Optimal Route Reflection\n"
						"ORR Group name\n")
{
