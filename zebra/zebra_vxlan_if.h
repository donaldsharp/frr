...
extern struct zebra_vxlan_vni * zebra_vxlan_if_vni_find(const struct zebra_if *zif, vni_t vni);
...
extern int zebra_vxlan_if_vni_up(struct interface *ifp, struct zebra_vxlan_vni *vni);
extern int zebra_vxlan_if_up(struct interface *ifp);
extern int zebra_vxlan_if_vni_del(struct interface *ifp, vni_t vni);
extern int zebra_vxlan_if_del(struct interface *ifp);
extern int zebra_vxlan_if_vni_table_add_update(struct interface *ifp, struct hash *vni_table);
...
extern int zebra_vxlan_if_vni_add(struct interface *ifp, struct zebra_vxlan_vni *vni);
