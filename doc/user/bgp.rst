...
.. clicmd:: show [ip] bgp [afi] [safi] [all] neighbors A.B.C.D [advertised-routes|received-routes|filtered-route] [json|wide]
...
.. index:: show [ip] bgp [afi] [safi] [all] prefix-list WORD [wide|json]
...
.. index:: show [ip] bgp [afi] [safi] [all] route-map WORD [wide|json]
...
.. index:: show [ip] bgp [afi] [safi] [all] <A.B.C.D/M|X:X::X:X/M> longer-prefixes [wide|json]
...
.. index:: show [ip] bgp [afi] [safi] [all] filter-list WORD [wide|json]
...
.. index:: show [ip] bgp <ipv4|ipv6> community-list WORD [json]
.. clicmd:: show [ip] bgp <ipv4|ipv6> community-list WORD [json]

.. index:: show [ip] bgp <ipv4|ipv6> community-list WORD exact-match [json]
